...
const codecept_dir = path.join(__dirname, '/../data/sandbox/configs/your-config-dir')
...
describe('After hook failure', () => {
  it('should not skip remaining scenarios when After hook throws', done => {
    exec(`${codecept_run} after_hook_fail_test.js`, (err, stdout, stderr) => {
      ...
      stdout.should.include('After hook - throwing error')
